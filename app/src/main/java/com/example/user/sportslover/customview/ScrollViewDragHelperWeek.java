...
public class ScrollViewDragHelperWeek extends LinearLayout {

    private ViewDragHelper viewDragHelper;
    private ScrollBarPicWeek scrollBarPic;
    ...
    @SuppressLint("NewApi")
    public ScrollViewDragHelperWeek(Context context, AttributeSet attrs,
                                int defStyle) {
    ...
    public ScrollViewDragHelperWeek(Context context) {
        this(context, null);
    }
                ...
                new ViewDragHelper.Callback() {
                    ...
                    public void onViewReleased(View releasedChild, float xvel,
                        ...
                        if (viewDragHelper.smoothSlideViewTo(scrollBarPic,
                            ...
                            ViewCompat
                                    .postInvalidateOnAnimation(ScrollViewDragHelperWeek.this);
                        }
                    }
    ...
    protected void onFinishInflate() {
        scrollBarPic = (ScrollBarPicWeek) getChildAt(0);
