...
public class DynamicModel implements DynamicModelImpl {
     ...
     */
    @Override
    public void getDynamicItem(final SportModelImpl.BaseListener listener) {
     ...
     */
    @Override
    public void getDynamicItemByPhone(User user, final SportModelImpl.BaseListener listener) {
        BmobQuery<DynamicItem> query = new BmobQuery<DynamicItem>();
     ...
     * @param dynamicitem
     */
    public void sendDynamicItem(final DynamicItem dynamicitem, final SportModelImpl.BaseListener listener) {
