...
public class ScrollBarPicWeek extends View {
    ...
    public ScrollBarPicWeek(Context context) {
        this(context, null);
    }

    public ScrollBarPicWeek(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ScrollBarPicWeek(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int width;
        width = (perBarWidth + barPadding) * 7;// this的宽度
