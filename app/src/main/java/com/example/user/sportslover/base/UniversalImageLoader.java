...
import com.example.user.sportslover.util.DisplayConfig;
...
public class UniversalImageLoader implements ILoader {
    ...
    private void display(ImageView iv, String url, boolean isCircle, int defaultRes,
        ...
        if (!url.equals(iv.getTag())) {//增加tag标记，减少UIL的display次数
            ...
            ImageLoader.getInstance().displayImage(url, imageAware, DisplayConfig
                    .getDefaultOptions(isCircle, defaultRes), listener);
        }
    }
