...
public class ScrollViewDragHelperMonth extends LinearLayout {

    private ViewDragHelper viewDragHelper;
    private ScrollBarPicMonth scrollBarPic;
    ...
    @SuppressLint("NewApi")
    public ScrollViewDragHelperMonth(Context context, AttributeSet attrs,
                                    int defStyle) {
    ...
    public ScrollViewDragHelperMonth(Context context) {
        this(context, null);
    }
                ...
                new ViewDragHelper.Callback() {
                    ...
                    public void onViewReleased(View releasedChild, float xvel,
                        ...
                        if (viewDragHelper.smoothSlideViewTo(scrollBarPic,
                            ...
                            ViewCompat
                                    .postInvalidateOnAnimation(ScrollViewDragHelperMonth.this);
                        }
                    }
    ...
    protected void onFinishInflate() {
        scrollBarPic = (ScrollBarPicMonth) getChildAt(0);
