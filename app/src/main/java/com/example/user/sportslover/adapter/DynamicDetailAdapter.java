...
//
//    public DynamicDetailAdapter(Context context, int layoutRes, List<DynamicItem> datas) {
...
//        DynamicDetailAdapter.ViewHolder holder = null;
//        if (convertView == null) {
//            convertView = mInflater.inflate(mLayoutRes, null);
//            holder = new DynamicDetailAdapter.ViewHolder();
...
//        final DynamicAdapter.ViewHolder viewHolder = holder;
